# Auto-generated by asn1ate on 2016-05-24 12:58:02.067378
...
class DiscountInformationList(univ.SequenceOf):
    pass


DiscountInformationList.tagSet = univ.SequenceOf.tagSet.tagImplicitly(tag.Tag(tag.tagClassApplication, tag.tagFormatSimple, 97))
DiscountInformationList.componentType = DiscountInformation()
...
HSCSDInformation.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType('hSCSDParameterModification', HSCSDParameterModification())
)
...
CallReference.tagSet = univ.Integer.tagSet.tagImplicitly(tag.Tag(tag.tagClassApplication, tag.tagFormatSimple, 45))
...
class ServiceCentreIdentity(Msisdn):
    pass


ServiceCentreIdentity.tagSet = Msisdn.tagSet.tagImplicitly(tag.Tag(tag.tagClassApplication, tag.tagFormatSimple, 197))
